...
#**Updated narrative personas for Milestone 3:**#
...
image::../Images/jobseeker-flows.svg[Jobseeker Flow, align=center, pdfwidth=50%]
...
image::../Images/recruiter-flows.svg[Recruiter Flow, align=center, pdfwidth=50%]
...
image::../Images/student-flows.svg[Student Flow, align=center, pdfwidth=50%]
...
.Flowchart LTT – Modeling Out Loud for Swipe Flow
