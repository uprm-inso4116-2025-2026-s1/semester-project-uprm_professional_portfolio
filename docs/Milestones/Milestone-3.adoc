...
image::../Images/jobseeker-flows.svg[Jobseeker Flow, align=center, width=40%]
...
image::../Images/recruiter-flows.svg[Recruiter Flow, align=center, width=40%]
...
Layered view (Presentation, Application, Domain, Infrastructure, Cross-cutting concerns)
