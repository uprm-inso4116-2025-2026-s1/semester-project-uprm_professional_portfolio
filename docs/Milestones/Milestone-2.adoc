...
Second Milestone - Software Design - INSO 4115
...
* **Immediate response:** Recruiter defines roles and requirements; organizer or university disseminates information +
...
.Candidate just arrived and checked in to event
...
.Queue now formed in front of a booth
* **Triggered by:** Candidates +
* **Immediate response:** Candidates wait; staff organizes the line +
* **Expected outcome/postcondition:** Long wait times and short interactions +
* **Reference to Sketch:** Reports of waiting up to forty minutes. "I stood in line 40 minutes just to hand over my resume."

---

.Recruiter just solicited introduction
...
.Resume or portfolio is being handed over
* **Triggered by:** Candidate +
* **Immediate response:** Recruiter receives and sorts document (physical or digital) +
* **Expected outcome/postcondition:** Document enters a pile or list and may lose visibility +
...
.Informal hallway or meetup conversation occurred
* **Triggered by:** Candidate and Recruiter +
* **Immediate response:** Unplanned exchange outside the booth +
* **Expected outcome/postcondition:** New lead or opportunity may emerge +
* **Reference to Sketch:** Informal interactions valued more than booth chats

---

.Application has been submitted through multiple portals
* **Triggered by:** Candidate +
* **Immediate response:** Candidate uploads resume to Handshake, LinkedIn, and company website or submits via referral +
* **Expected outcome/postcondition:** Duplicate entries for the same profile; confusion about visibility +
* **Reference to Sketch:** Uncertainty about whether multichannel applications are reviewed. "Did they even see my application?"

---

.Pre-screen just completed
* **Triggered by:** Recruiter or System +
* **Immediate response:** Recruiter applies heuristics (year, skills, seniority) or system filters applications +
...
* **Reference to Sketch:** Search ends once early candidates meet expectations. “If the first batch looks good, we stop looking.”

---

.Known talent has been rehired
* **Triggered by:** Recruiter +
* **Immediate response:** Recruiter prioritizes former interns or previous employees +
* **Expected outcome/postcondition:** Faster hiring due to established trust +
...
* **Reference to Sketch:** Students often remember companies by their swag
...
*Recruiter* +  
Recruiters define roles and specify requirements, publish openings, and schedule participation in recruiting events. They post and update job details across platforms such as Handshake, LinkedIn, or internal company sites. During and after events, they record short observations about candidates and apply prescreening heuristics based on visible skills, year, or seniority. Recruiters also send invitations to interview, issue follow-up messages, and decide whether to pause or stop active sourcing once a satisfactory pool has been reached.

*System/Institution* +  
Institutions and systems announce recruiting events, register candidate check-ins, and collect and store application records. They perform deduplication of multichannel entries, apply automated prescreening filters, and maintain versioning for traceability and compliance.

*Third parties* +  
Third-party actors such as referees or background-check providers submit references, return verification results, and confirm candidate details.

===== Behaviors

.**Candidate engagement and application behavior**
This behavior encompasses the end-to-end process through which a candidate interacts with the recruiting process. It begins when the recruiting event is announced and the candidate adjusts their resume and portfolio to match desired roles (action). Upon arrival, the candidate checks in (event) and approaches booths to deliver a brief introduction (action). They hand over a resume (event) and often follow up by submitting applications through multiple portals (action). After the event, they may send follow-up messages or withdraw applications (action). These linked steps form a behavioral arc that involves preparation, event participation, and post-event actions. +
 +  
...
.**Communication delay leading to attrition**
This behavior captures what happens when outreach is delayed. Recruiters queue candidates for later contact (action), resulting in delayed invitations or follow-ups (event). Once contacted, some candidates withdraw or accept other offers (event/action). +    
 +
*Reference to Sketch:* Recruiters contact students weeks later, by which time many are unavailable. +

---

.**Informal networking conversion behavior**
This behavior occurs when informal, unplanned exchanges result in hiring outcomes. An informal hallway conversation happens (event), followed by a recruiter or candidate initiating a focused follow-up (action) and logging or scheduling an interview (action). +    
 +
*Reference to Sketch:* Informal conversations often produce stronger opportunities than planned booth exchanges. +

---

.**Brand recall and reengagement through giveaways**
This behavior connects marketing actions to later candidate responses. Recruiters distribute promotional materials or swag (action/event), after which candidates recall the brand and reengage during outreach (event/action). +    
 +
*Reference to Sketch:* Students remember companies through giveaways, which enhances follow-up engagement. +

---

.**Rehiring based on prior trust**
This behavior involves drawing from known, trusted candidates. Systems maintain records of past interns or employees (action), enabling quick rehire decisions (event/action) and onboarding (action). + 
 + 
*Reference to Sketch:* Recruiters often rehire previous interns due to established trust and reduced uncertainty. +
