...
.María “New Grad” Rivera (mobile-first)
[cols="1,3"]
|===
...
.Luis “Switcher” Santiago (privacy-first)
[cols="1,3"]
|===
...
.Karla “Campus Recruiter” Gómez (events & funnel)
[cols="1,3"]
|===
...
.Jorge “HR Generalist” Ortiz (speed & safety)
[cols="1,3"]
|===
...
.Ana “Safe User” Lozada (safety-first)
[cols="1,3"]
|===
...
.Mina “International Grad” Shah (compliance-first, cross-time-zone)
[cols="1,3"]
|===
|Snapshot|International MS grad navigating visas and time zones; needs clarity and eligibility signals.
|Profile|24, MS in Data Science, international student on F-1 OPT; lives off-campus; phone for browsing, laptop for uploads.
